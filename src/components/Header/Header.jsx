               ...
               <div className="navbar-brand">
                  <a href="/">
                     <b className="logo-icon">
                        <img src={Image.logoIcon} alt="homepage" className="dark-logo" />
                        <img src={Image.logoIcon} alt="homepage" className="light-logo" />
                     </b>
                     <span className="logo-text">
                        <img src={Image.logoText} alt="homepage" className="dark-logo" />
                        <img src={Image.logoLightText} className="light-logo" alt="homepage" />
                     </span>
                  </a>
               </div>
               <a
